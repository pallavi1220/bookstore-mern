    ...
    Cart && Cart.length === 0 && (
      <div className="h-screen">
        <div className="h-[100%] flex items-center justify-center flex-col">
          ...
          <img src="https://cdn-icons-png.flaticon.com/128/11329/11329060.png" alt="empty-cart" className="lg:h[50vh]" />
        </div>
      </div>
    )
   }
    ...
    {Cart.map((items, i)=>(
      ...
      >
       ...
       <div className="w-full md:w-auto">
        ...
        <p className="text-normal text-zinc-300 mt-2 hidden md:hidden lg:block">{items.desc.slice(0,100)}...</p>
         {/* <p className="text-normal text-zinc-300 mt-2 hidden md:block lg:hidden">{items.desc.slice(0,65)}...</p> */}
          {/* <p className="text-normal text-zinc-300 mt-2 hidden md:hidden lg:block">{items.desc.slice(0,100)}...</p> */}
       </div>
       <div className="flex mt-4 w-full md:w-auto items-center justify-between">
        <h2 className="text-zinc-100 tet-3xl font-semibold flex">
          ₹ {items.price}
        </h2>
    ...
    <div className="mt-4 w-full flex items-center justify-end">
      <div className="p-4 bg-zinc-800 rounded ">
        ...
        <div className="w-[100%] mt-3">
          ...
          hover:bg-zinc-500 transition-all duration-300"  onClick={PlaceOrder}>
            Place Your Order
